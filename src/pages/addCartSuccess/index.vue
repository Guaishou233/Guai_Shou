      ...
      <div class="goods">
        <div class="left-good">
          ...
          <div class="right-info">
            ...
            <p class="attr">数量:{{$route.query.itemNum}}</p>
          </div>
        </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        info:JSON.parse(sessionStorage.getItem('ITEMDESCIONINFO'))||{},
        color:JSON.parse(sessionStorage.getItem('ITEMCOLORINFO')) ||{},
        version:JSON.parse(sessionStorage.getItem('ITEMVERSIONINFO')) ||{},
      }
    },
  }
</script>
